...
return [
    ...
    'attributes'           => [
        ...
        'aisles'                   => 'pasillos',
        'aisles.*.code'            => 'código',
        'aisles.*.columns'         => 'columnas',
        'aisles.*.group_id'        => 'grupo',
        'aisles.*.rows'            => 'filas',
        'amount'                   => 'cantidad',
        ...
        'key'                      => 'clave',
        'last_name'                => 'apellidos',
        'legal_representative_name' => 'nombre representante legal',
        'legal_representative_position' => 'cargo representante legal',
        'legal_representative_rut' => 'rut representante legal',
        'lesson'                   => 'lección',
