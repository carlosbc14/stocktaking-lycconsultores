...
return [
    ...
    'attributes'           => [
        ...
        'line_of_business'         => 'línea de negocio',
        'locations.*.line_of_business' => 'línea de negocio',
        'locations.*.aisle'        => 'pasillo',
        'locations.*.code'         => 'código',
        'login'                    => 'acceso',
        'message'                  => 'mensaje',
        ...
        'products.*.code_sku'      => 'código sku',
        'products.*.description'   => 'descripción',
        'products.*.institution'   => 'institución',
